...
_grctest:     file format elf32-i386
...
main(int argc, char *argv[])
{
  ...
  printf(1, "getreadcount is %d\n", getreadcount());
  15:	e8 99 02 00 00       	call   2b3 <getreadcount>
 ...
 34c:	89 d1                	mov    %edx,%ecx
{
 ...
 3be:	56                   	push   %esi
 3bf:	57                   	push   %edi
 3c0:	e8 f6 fe ff ff       	call   2bb <write>
  while(--i >= 0)
...
printf(int fd, const char *fmt, ...)
{
 ...
 439:	e8 7d fe ff ff       	call   2bb <write>
 ...
 499:	e8 1d fe ff ff       	call   2bb <write>
        putc(fd, c);
      } else {
 ...
 4ad:	e8 09 fe ff ff       	call   2bb <write>
  for(i = 0; fmt[i]; i++){
 ...
 521:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 524:	e8 92 fd ff ff       	call   2bb <write>
        ap++;
 ...
 574:	eb 1a                	jmp    590 <printf+0x1a0>
          s = "(null)";
 576:	bb 6c 07 00 00       	mov    $0x76c,%ebx
        while(*s != 0){
 ...
 59b:	57                   	push   %edi
 59c:	53                   	push   %ebx
 59d:	e8 19 fd ff ff       	call   2bb <write>
        while(*s != 0){
...
free(void *ap)
{
 ...
 5c5:	a1 1c 0a 00 00       	mov    0xa1c,%eax
{
 ...
 5e6:	73 10                	jae    5f8 <free+0x38>
{
 ...
 611:	5b                   	pop    %ebx
  freep = p;
 612:	a3 1c 0a 00 00       	mov    %eax,0xa1c
}
 617:	5e                   	pop    %esi
 618:	5f                   	pop    %edi
 619:	5d                   	pop    %ebp
 ...
 637:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 63a:	a3 1c 0a 00 00       	mov    %eax,0xa1c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 65d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 660:	8b 3d 1c 0a 00 00    	mov    0xa1c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6a9:	8b 3d 1c 0a 00 00    	mov    0xa1c,%edi
 ...
 6bb:	e8 63 fc ff ff       	call   323 <sbrk>
  if(p == (char*)-1)
 ...
 6d2:	e8 e9 fe ff ff       	call   5c0 <free>
  return freep;
 6d7:	a1 1c 0a 00 00       	mov    0xa1c,%eax
 ...
 704:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 707:	a3 1c 0a 00 00       	mov    %eax,0xa1c
}
 ...
 727:	0a 00 00 
    base.s.size = 0;
 72a:	bf 20 0a 00 00       	mov    $0xa20,%edi
    base.s.ptr = freep = prevp = &base;
 72f:	c7 05 20 0a 00 00 20 	movl   $0xa20,0xa20
 736:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 739:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 73b:	c7 05 24 0a 00 00 00 	movl   $0x0,0xa24
 742:	00 00 00 
    if(p->s.size >= nunits){
