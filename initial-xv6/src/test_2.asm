...
main(int argc, char *argv[]) {
  ...
  1d:	81 ec 88 00 00 00    	sub    $0x88,%esp
    int x1 = getreadcount();
  23:	e8 db 02 00 00       	call   303 <getreadcount>
  ...
  51:	e8 95 02 00 00       	call   2eb <wait>
	int x2 = getreadcount();
  56:	e8 a8 02 00 00       	call   303 <getreadcount>
	total += (x2 - x1);
 ...
 39c:	89 d1                	mov    %edx,%ecx
{
 ...
 40e:	56                   	push   %esi
 40f:	57                   	push   %edi
 410:	e8 f6 fe ff ff       	call   30b <write>
  while(--i >= 0)
...
printf(int fd, const char *fmt, ...)
{
 ...
 489:	e8 7d fe ff ff       	call   30b <write>
 ...
 4e9:	e8 1d fe ff ff       	call   30b <write>
        putc(fd, c);
      } else {
 ...
 4fd:	e8 09 fe ff ff       	call   30b <write>
  for(i = 0; fmt[i]; i++){
 ...
 571:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 574:	e8 92 fd ff ff       	call   30b <write>
        ap++;
 ...
 5eb:	57                   	push   %edi
 5ec:	53                   	push   %ebx
 5ed:	e8 19 fd ff ff       	call   30b <write>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 70b:	e8 63 fc ff ff       	call   373 <sbrk>
  if(p == (char*)-1)
