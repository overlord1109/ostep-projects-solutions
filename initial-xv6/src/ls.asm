 ...
 65c:	89 d1                	mov    %edx,%ecx
{
 ...
 6ce:	56                   	push   %esi
 6cf:	57                   	push   %edi
 6d0:	e8 f6 fe ff ff       	call   5cb <write>
  while(--i >= 0)
...
printf(int fd, const char *fmt, ...)
{
 ...
 749:	e8 7d fe ff ff       	call   5cb <write>
 ...
 7a9:	e8 1d fe ff ff       	call   5cb <write>
        putc(fd, c);
      } else {
 ...
 7bd:	e8 09 fe ff ff       	call   5cb <write>
  for(i = 0; fmt[i]; i++){
 ...
 831:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 834:	e8 92 fd ff ff       	call   5cb <write>
        ap++;
 ...
 8ab:	57                   	push   %edi
 8ac:	53                   	push   %ebx
 8ad:	e8 19 fd ff ff       	call   5cb <write>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 9cb:	e8 63 fc ff ff       	call   633 <sbrk>
  if(p == (char*)-1)
