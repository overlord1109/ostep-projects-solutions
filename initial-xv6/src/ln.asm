 ...
 37c:	89 d1                	mov    %edx,%ecx
{
 ...
 3ee:	56                   	push   %esi
 3ef:	57                   	push   %edi
 3f0:	e8 f6 fe ff ff       	call   2eb <write>
  while(--i >= 0)
...
printf(int fd, const char *fmt, ...)
{
 ...
 469:	e8 7d fe ff ff       	call   2eb <write>
 ...
 4c9:	e8 1d fe ff ff       	call   2eb <write>
        putc(fd, c);
      } else {
 ...
 4dd:	e8 09 fe ff ff       	call   2eb <write>
  for(i = 0; fmt[i]; i++){
 ...
 551:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 554:	e8 92 fd ff ff       	call   2eb <write>
        ap++;
 ...
 5cb:	57                   	push   %edi
 5cc:	53                   	push   %ebx
 5cd:	e8 19 fd ff ff       	call   2eb <write>
        while(*s != 0){
