...
printf(int fd, const char *fmt, ...)
{
 ...
 549:	e8 7d fe ff ff       	call   3cb <write>
 ...
 5a9:	e8 1d fe ff ff       	call   3cb <write>
        putc(fd, c);
      } else {
 ...
 5bd:	e8 09 fe ff ff       	call   3cb <write>
  for(i = 0; fmt[i]; i++){
 ...
 631:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 634:	e8 92 fd ff ff       	call   3cb <write>
        ap++;
 ...
 6ab:	57                   	push   %edi
 6ac:	53                   	push   %ebx
 6ad:	e8 19 fd ff ff       	call   3cb <write>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 7cb:	e8 63 fc ff ff       	call   433 <sbrk>
  if(p == (char*)-1)
