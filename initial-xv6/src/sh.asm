...
00000db3 <getreadcount>:
SYSCALL(getreadcount)
     db3:	b8 16 00 00 00       	mov    $0x16,%eax
     db8:	cd 40                	int    $0x40
     dba:	c3                   	ret    
     ...
     e4c:	89 d1                	mov    %edx,%ecx
{
  ...
  write(fd, &c, 1);
     ...
     ebe:	56                   	push   %esi
     ebf:	57                   	push   %edi
     ec0:	e8 f6 fe ff ff       	call   dbb <write>
  while(--i >= 0)
...
printf(int fd, const char *fmt, ...)
{
  ...
  write(fd, &c, 1);
     ...
     f39:	e8 7d fe ff ff       	call   dbb <write>
  ...
  write(fd, &c, 1);
     ...
     f99:	e8 1d fe ff ff       	call   dbb <write>
        putc(fd, c);
      } else {
  ...
  write(fd, &c, 1);
     ...
     fad:	e8 09 fe ff ff       	call   dbb <write>
  for(i = 0; fmt[i]; i++){
  ...
  write(fd, &c, 1);
    1024:	e8 92 fd ff ff       	call   dbb <write>
        ap++;
  ...
  write(fd, &c, 1);
    ...
    109b:	57                   	push   %edi
    109c:	53                   	push   %ebx
    109d:	e8 19 fd ff ff       	call   dbb <write>
        while(*s != 0){
...
malloc(uint nbytes)
{
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    11bb:	e8 63 fc ff ff       	call   e23 <sbrk>
  if(p == (char*)-1)
