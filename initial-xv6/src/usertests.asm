...
000039a3 <getreadcount>:
SYSCALL(getreadcount)
    39a3:	b8 16 00 00 00       	mov    $0x16,%eax
    39a8:	cd 40                	int    $0x40
    39aa:	c3                   	ret    
    ...
    3a3c:	89 d1                	mov    %edx,%ecx
{
  ...
  write(fd, &c, 1);
    ...
    3aae:	56                   	push   %esi
    3aaf:	57                   	push   %edi
    3ab0:	e8 f6 fe ff ff       	call   39ab <write>
  while(--i >= 0)
...
printf(int fd, const char *fmt, ...)
{
  ...
  write(fd, &c, 1);
    ...
    3b29:	e8 7d fe ff ff       	call   39ab <write>
  ...
  write(fd, &c, 1);
    ...
    3b89:	e8 1d fe ff ff       	call   39ab <write>
        putc(fd, c);
      } else {
  ...
  write(fd, &c, 1);
    ...
    3b9d:	e8 09 fe ff ff       	call   39ab <write>
  for(i = 0; fmt[i]; i++){
  ...
  write(fd, &c, 1);
    3c14:	e8 92 fd ff ff       	call   39ab <write>
        ap++;
  ...
  write(fd, &c, 1);
    ...
    3c8b:	57                   	push   %edi
    3c8c:	53                   	push   %ebx
    3c8d:	e8 19 fd ff ff       	call   39ab <write>
        while(*s != 0){
...
malloc(uint nbytes)
{
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    3dab:	e8 63 fc ff ff       	call   3a13 <sbrk>
  if(p == (char*)-1)
