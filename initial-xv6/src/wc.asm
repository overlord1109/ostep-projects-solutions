 ...
 4ac:	89 d1                	mov    %edx,%ecx
{
 ...
 51e:	56                   	push   %esi
 51f:	57                   	push   %edi
 520:	e8 f6 fe ff ff       	call   41b <write>
  while(--i >= 0)
...
printf(int fd, const char *fmt, ...)
{
 ...
 599:	e8 7d fe ff ff       	call   41b <write>
 ...
 5f9:	e8 1d fe ff ff       	call   41b <write>
        putc(fd, c);
      } else {
 ...
 60d:	e8 09 fe ff ff       	call   41b <write>
  for(i = 0; fmt[i]; i++){
 ...
 681:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 684:	e8 92 fd ff ff       	call   41b <write>
        ap++;
 ...
 6fb:	57                   	push   %edi
 6fc:	53                   	push   %ebx
 6fd:	e8 19 fd ff ff       	call   41b <write>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 81b:	e8 63 fc ff ff       	call   483 <sbrk>
  if(p == (char*)-1)
