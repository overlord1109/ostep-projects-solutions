 ...
 42c:	89 d1                	mov    %edx,%ecx
{
 ...
 49e:	56                   	push   %esi
 49f:	57                   	push   %edi
 4a0:	e8 f6 fe ff ff       	call   39b <write>
  while(--i >= 0)
...
printf(int fd, const char *fmt, ...)
{
 ...
 519:	e8 7d fe ff ff       	call   39b <write>
 ...
 579:	e8 1d fe ff ff       	call   39b <write>
        putc(fd, c);
      } else {
 ...
 58d:	e8 09 fe ff ff       	call   39b <write>
  for(i = 0; fmt[i]; i++){
 ...
 601:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 604:	e8 92 fd ff ff       	call   39b <write>
        ap++;
 ...
 67b:	57                   	push   %edi
 67c:	53                   	push   %ebx
 67d:	e8 19 fd ff ff       	call   39b <write>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 79b:	e8 63 fc ff ff       	call   403 <sbrk>
  if(p == (char*)-1)
