...
printf(int fd, const char *fmt, ...)
{
 ...
 4f9:	e8 7d fe ff ff       	call   37b <write>
 ...
 559:	e8 1d fe ff ff       	call   37b <write>
        putc(fd, c);
      } else {
 ...
 56d:	e8 09 fe ff ff       	call   37b <write>
  for(i = 0; fmt[i]; i++){
 ...
 5e1:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 5e4:	e8 92 fd ff ff       	call   37b <write>
        ap++;
 ...
 65b:	57                   	push   %edi
 65c:	53                   	push   %ebx
 65d:	e8 19 fd ff ff       	call   37b <write>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 77b:	e8 63 fc ff ff       	call   3e3 <sbrk>
  if(p == (char*)-1)
