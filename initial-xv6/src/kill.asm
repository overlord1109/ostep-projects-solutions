 ...
 38c:	89 d1                	mov    %edx,%ecx
{
 ...
 3fe:	56                   	push   %esi
 3ff:	57                   	push   %edi
 400:	e8 f6 fe ff ff       	call   2fb <write>
  while(--i >= 0)
...
printf(int fd, const char *fmt, ...)
{
 ...
 479:	e8 7d fe ff ff       	call   2fb <write>
 ...
 4d9:	e8 1d fe ff ff       	call   2fb <write>
        putc(fd, c);
      } else {
 ...
 4ed:	e8 09 fe ff ff       	call   2fb <write>
  for(i = 0; fmt[i]; i++){
 ...
 561:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 564:	e8 92 fd ff ff       	call   2fb <write>
        ap++;
 ...
 5db:	57                   	push   %edi
 5dc:	53                   	push   %ebx
 5dd:	e8 19 fd ff ff       	call   2fb <write>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 6fb:	e8 63 fc ff ff       	call   363 <sbrk>
  if(p == (char*)-1)
